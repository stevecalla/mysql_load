const query_most_recent_create_on_date = `
    ...
    SELECT 
        ...
        DATE_FORMAT(CONVERT_TZ(most_recent_event_update, '+00:00', '+00:00'), '%Y-%m-%d %H:%i:%s UTC') AS most_recent_event_update_utc,
        ...
        TIMESTAMPDIFF(HOUR, most_recent_event_update, CURRENT_TIMESTAMP()) as time_stamp_difference,
    --     TIMESTAMPDIFF(HOUR, '2024-10-19 03:41:54', '2024-10-19 03:51:54') as time_stamp_difference_hour, -- in whole hours
    --     TIMESTAMPDIFF(MINUTE, '2024-10-19 03:41:54', '2024-10-19 05:50:54') as time_stamp_difference_minutes, -- in minutes
        CASE
