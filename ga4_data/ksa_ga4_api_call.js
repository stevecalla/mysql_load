...
// query
// const propertyId = '379087073'; // UAE GA4
// const propertyId = '406336023'; // KSA GA4
const propertyId = '177730843'; // FIREBASE 
const request = { "property": `properties/${propertyId}`, "dimensions": [{ "name": "date" }], "metrics": [{ "name": "sessions" }, { "name": "sessionConversionRate" },], "dateRanges": [{ "startDate": "180daysAgo", "endDate": "yesterday" }], "limit": "180" };
