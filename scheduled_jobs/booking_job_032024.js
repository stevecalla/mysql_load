...
const { execute_load_data_to_bigquery } = require('../load_bigquery/move_data_to_bigquery/step_0_load_main_job_040424'); //stefalse
...
let run_step_6 = false;     // upload data to google cloud / bigqtrue
